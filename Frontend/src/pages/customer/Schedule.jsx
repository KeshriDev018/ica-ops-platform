    ...
    const loadData = async () => {
      try {
        ...
        if (accountStudents.length > 0) {
          const allSchedules = await scheduleService.getByStudentId(accountStudents[0].student_id)
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-secondary font-bold text-navy mb-2">Schedule</h1>
          <p className="text-gray-600">View and manage your chess class schedule</p>
        </div>
      </div>
