...
import CustomerCoach from "./pages/customer/Coach";
import CustomerBatch from "./pages/customer/Batch";
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="classes" element={<CustomerClasses />} />
          <Route path="coach" element={<CustomerCoach />} />
